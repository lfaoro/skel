# Optional Librewolf browser configuration.
#
# Usage:
#   Import this module in your home.nix when you want it:
#     imports = [ ./modules/librewolf.nix ];
#
# This module contains a heavily customized Librewolf setup with strict
# privacy and security settings (sourced from the user's prefs.js).
#
# Note: The actual Librewolf package on non-NixOS systems is often installed
# via the system package manager (see bin/i-librewolf.sh using extrepo).
...
{ pkgs, ... }:
{
  programs.librewolf = {
    ...
    # Settings derived from prefs.js
    settings = {
      # Accessibility
